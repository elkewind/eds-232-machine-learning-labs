...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\#q6 find number of cities}
\FunctionTok{length}\NormalTok{(}\FunctionTok{unique}\NormalTok{(baked\_pumpkins}\SpecialCharTok{$}\NormalTok{city\_name))}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{cor}\NormalTok{(baked\_pumpkins}\SpecialCharTok{$}\NormalTok{variety, baked\_pumpkins}\SpecialCharTok{$}\NormalTok{price)}
\end{Highlighting}
\end{Shaded}
